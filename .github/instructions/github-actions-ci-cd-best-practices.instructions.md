...
- **Guidance for Copilot:**
    ...
    - Use emojis minimally in step and job names. While they can improve visual scanning in the GitHub UI, overuse creates clutter and reduces professionalism. Prefer clear, descriptive names over emoji decoration.
